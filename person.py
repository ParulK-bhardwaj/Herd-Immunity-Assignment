...
class Person(object):
    """The class Person has an id, is_vaccinated and possibly an infection"""
    ...
    def did_survive_infection(self):
        """
            A method to define if a person survived the infection or not.

            Returns:
                boolean: True if the person survived the infection and is alive else False if the person did not survive the infection.
        """
